    ...
    <div className="relative font-sans min-h-screen flex flex-col overflow-x-hidden">
      ...
      >
        <div className="w-full max-w-xl flex flex-col gap-6 items-start">
          <h2 className="text-[28px] sm:text-[36px] font-bold text-gray-200 mb-6">Here are my projects:</h2>
          <ul className="flex flex-col gap-4">
            <li>
              <Link href="https://your-app-link.com" className="text-gray-200 underline pointer-events-auto" target="_blank" rel="noopener noreferrer">
                App
              </Link>
            </li>
          </ul>
