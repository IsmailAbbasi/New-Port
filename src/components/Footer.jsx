export default function Footer() {
  return (
        ...
        <a
  href="https://medium.com/@ismailabbasi118"
  target="_blank"
  rel="noopener noreferrer"
  className="rounded-full border border-white/10 bg-white/5 backdrop-blur-lg p-1.5 flex items-center justify-center transition hover:bg-white/20 hover:border-white/30"
  aria-label="Medium"
>
  ...
  >
    <path d="M4 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4zm4.8 6.3v7.4c0 .2.1.3.2.3.1 0 .2 0 .3-.1l3.7-1.9 3.7 1.9c.1.1.2.1.3.1.1 0 .2-.1.2-.3V10.3c0-.1 0-.2-.1-.2l-4-2c-.1-.1-.3-.1-.4 0l-4 2c-.1 0-.1.1-.1.2z"/>
  </svg>
</a>
        </div>
